...
def get_admin_news():
    ...
    for article in article_card:
        ...
        with open("json/amin.json", "w", encoding="utf8") as file:
        ...
        with open("json/amin_ready.json", "w", encoding="utf8") as file:
            json.dump(new_dict, file, indent=4, ensure_ascii=False)

def check_news_update():
    with open("json/amin_ready.json", encoding="utf8") as file:
        news_dict = json.load(file)
    ...
    for article in article_card:
        ...
        url_admin_json = f'https://habr.com/kek/v2/articles/{article_id}/?fl=ru&hl=ru'
        r_dev = requests.get(url=url_admin_json, headers=headers, proxies=proxies)

        with open("json/admin.json", "w", encoding="utf8") as file:
            json.dump(r_dev.json(), file, indent=4, ensure_ascii=False)

        with open("json/admin.json", encoding="utf8") as file:
            news_dict = json.load(file)
        ...
        with open("json/admin_ready.json", "w", encoding="utf8") as file:
            json.dump(new_dict, file, indent=4, ensure_ascii=False)
